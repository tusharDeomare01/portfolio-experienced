...
const ThreeDCarousel = ({
  ...
  tagline:
    _tagline = "Explore how our textile sensor technology is revolutionizing multiple industries with intelligent fabric solutions tailored to specific needs.",
  ...
  useEffect(() => {
    if (autoRotate && isInView && !isHovering && !pauseAutoRotate) {
