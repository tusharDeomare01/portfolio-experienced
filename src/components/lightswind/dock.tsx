...
function DockItem({
  ...
  return (
    <motion.div
      ...
      onClick={onClick}
      className="relative inline-flex items-center justify-center rounded-full bg-background shadow-md touch-manipulation active:scale-95 transition-transform"
      tabIndex={0}
      role="button"
      aria-haspopup="true"
    >
