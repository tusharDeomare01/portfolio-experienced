    ...
    <>
      <style>{`
        ...
        .animate-rotate-rays-2 {
          animation: rotateRays2 ${6 / animationSpeed}s linear ${10 / animationSpeed}s infinite;
        }
        .animate-color-rays {
          animation: colorRays ${5.5 / animationSpeed}s linear infinite, colorRaysReverse ${8 / animationSpeed}s linear infinite;
        }
